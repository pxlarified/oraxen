...
public class NMSHandler implements io.th0rgal.oraxen.nms.NMSHandler {
    ...
    public NMSHandler() {
        ...
        this.blockHandler = new io.th0rgal.oraxen.nms.v1_20_R3.BlockHandlerImpl();
    }
    ...
    public ItemStack copyItemNBTTags(@NotNull ItemStack oldItem, @NotNull ItemStack newItem) {
        ...
        oldTag.getAllKeys().stream().filter(key -> !vanillaKeys.contains(key))
                .forEach(key -> newTag.put(key, oldTag.get(key)));
